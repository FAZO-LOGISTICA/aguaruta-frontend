...
function LegendControl({ items }) {
  ...
  useEffect(() => {
    ...
    legend.onAdd = () => {
      ...
      div.innerHTML = items.map(({ camion, color }) =>
...
export default function Mapa() {
  ...
  useEffect(() => {
    if (allCamiones.length && selected.size === 0) setSelected(new Set(allCamiones));
  }, [allCamiones.length]);
  ...
  return (
    <div className="main-container fade-in">
      ...
      <MapContainer center={[-33.07, -71.63]} zoom={13}
